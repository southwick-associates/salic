...
*Note that residency (res) is a customer-level variable, but one that could conceivably change from year-to-year; hence the recommended sale-level specification.*
