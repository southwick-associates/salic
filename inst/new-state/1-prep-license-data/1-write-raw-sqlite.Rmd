...
f <- "E:/SA/Data-Dashboards/Data-sensitive/"
...
- Naming (db) should match to relevant "raw-[year].sqlite3" folder used above:
    + for example: "E:/SA/Data-Dashboards/Data-sensitive/IA/raw-2015.sqlite3"

```{r}
db <- src_sqlite("E:/SA/Data-Dashboards/Data-sensitive/", create = TRUE) 
