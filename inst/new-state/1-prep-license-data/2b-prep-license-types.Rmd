...
```{r}
db <- src_sqlite("E:/SA/Data-Dashboards/Data-sensitive/")
src_tbls(db)
```
...
I recommend exporting to a csv, and then saving an edited csv (or xlsx) with at least 3 variables (lic_id, description, type). This will be used in the next step (`2c-check-license-types`)
