...
*Guidelines: How do privilege customers change over time? This should end up being close to the top-level participants number that ends up in the dashboard (although it doesn’t account for effect of multi-year and lifetime licenses).*
